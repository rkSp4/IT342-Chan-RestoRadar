...
import { userService, UserProfile, reviewService, Review } from "../../shared/services/services";
...
export function ProfilePage() {
  ...
  const memberSince = profile?.joinDate
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            <div className="w-24 h-24 rounded-full bg-orange-100 text-orange-700 flex items-center justify-center text-3xl font-bold border-4 border-orange-100 flex-shrink-0">
              ...
              <div className="flex flex-wrap gap-6 justify-center md:justify-start">
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {loading ? "—" : profile?.favoriteCount ?? 0}
                  </div>
                  <div className="text-sm text-gray-600">Favorites</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">
                    {loading ? "—" : profile?.reviewCount ?? 0}
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">{loading ? "—" : `${profile?.reviewCount ?? 0} written`}</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">{loading ? "—" : memberSince}</p>
          </div>
        </div>
